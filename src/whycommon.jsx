...
import { NFTCONTRACT, STAKINGCONTRACT, polygonscanapi, moralisapi, Web3Alc } from './config';
...
const refreshPage = ()=>{
  ...
  return (
    <div className="App nftapp">
      <h2 className="titlefont p-3" style={{marginTop: "5px"}}>WHYteRabbitHole Common Collection</h2>
        <div className='px-5 mb-4'>
            <input id="connectbtn" type="button" className="connectbutton mt-2 bg-gradient border-warning" onClick={connectwallet} value="Connect Your Wallet" />
          </div>
        <div className='container container-style'>
          ...
          <form>
            <div className="row pt-3">
              <div>
                <h2 className="pt-2" style={{ fontWeight: "30" }}>WHY Common Minter</h2>
              </div>
            ...
            <div className="col">
                <Button className="button-style btn bg-gradient border-warning" onClick={mintnative} style={{ border: "0.2px", borderRadius: "75px", boxShadow: "1px 1px 5px #000000", backgroundColor: "#161616" }}>
                  <strong>MATIC</strong><img src="matic.png" width="51%" alt="matic" />
                </Button>
              </div>
              <div className="col ">
                <Button className="button-style btn bg-gradient border-warning" onClick={mint0} style={{ border: "0.2px", borderRadius: "75px", boxShadow: "1px 1px 5px #000000", backgroundColor: "#161616" }}>
                  <strong>KAROOTI</strong><img src={"token.png"} width="44%" alt="token" />
                </Button>
              </div>
              <div>
        ...
        <div className='col'>
          <body className='nftstaker border-0'>
            <form>
              ...
              <Button className="btn bg-gradient border-warning" onClick={enable} style={{ backgroundColor: "#161616", boxShadow: "1px 1px 5px #000000" }} >Authorize Your Wallet</Button>
              <div className="row px-3">
                <div className="col">
                  <form class="stakingrewards" style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff" }}>
                    ...
                    <Button className="btn bg-gradient border-warning" onClick={verify} style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }} >Verify</Button>
                    <table className='table mt-3 mb-5 px-3 table-dark'>
                      ...
                      <tr>
                        <td style={{ fontSize: "19px" }}>Unstake All Staked NFTs
                          <Button className="mb-3 bg-gradient border-warning" onClick={unstakeall} style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }}>Unstake All</Button>
                        </td>
                      </tr>
                    </table>
                  </form>
                  ...
                  <div className="col">
                    <form className='stakingrewards' style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff" }}>
                      ...
                      <Button className="btn bg-gradient border-warning" onClick={rewardinfo} style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }} >Earned KAROOTI Tokens</Button>
                      ...
                      <div className='col-12 mt-2'>
                        ...
                        <Button onClick={claimit} style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }} className="mb-2 bg-gradient border-warning">Claim</Button>
                      </div>
                    </form>
                  </div>
                </div>
      ...
      <Button className="mb-2 bg-gradient border-warning" onClick={refreshPage} style={{ backgroundColor: "#000000", boxShadow: "1px 1px 5px #000000" }}>Refresh NFT Portal</Button>
      </div>
